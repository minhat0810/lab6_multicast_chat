...
public class Sender extends JFrame {
	...
	public Sender() {
		...
		lblGroup_1.setBounds(672, 27, 67, 31);
		contentPane.add(lblGroup_1);
		
		 
		 groupBox = new JComboBox();
		groupBox.setBounds(739, 30, 112, 28);
		...
		btnJoin.addActionListener(new ActionListener() {
			...
			//	sendMessage(txtName.getName(), getName());
	            try {
//	                groupAddr = "230.0.0.1"; // Địa chỉ nhóm multicast
//	                groupAddress = InetAddress.getByName(IPgroup1);
//	                String groupName = "Group 1";
//	                System.out.println(groupAddress);
//	                multicastSocket = new MulticastSocket(12345);
//	                multicastSocket.joinGroup(groupAddress);
//	                
//	                isInGroup = true; // Cập nhật trạng thái là thành viên của nhóm
		...
		txtMessage.setBounds(248, 105, 512, 115);
		...
		btnSendMess.setBounds(770, 204, 86, 31);
